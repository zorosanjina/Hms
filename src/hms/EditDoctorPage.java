...
public class EditDoctorPage extends JFrame implements ActionListener {
    ...
    private void loadDoctorDetails(String id) {
        try {
            ...
            if (rs.next()) {
                ...
                tf4.setText(rs.getString("specialization"));
                cb1.setSelectedItem(rs.getString("gender"));
                tf5.setText(rs.getString("phone"));
                tf6.setText(rs.getString("email"));
                tf7.setText(rs.getString("dob"));
                tf8.setText(rs.getString("age"));
                ta1.setText(rs.getString("address"));
                tf9.setText(rs.getString("id"));
            } else {
        ...
        if (ae.getSource() == bt1) {
            ...
            if (name.isEmpty() || username.isEmpty() || password.isEmpty() || specialization.isEmpty() || gender.isEmpty() || phone.isEmpty() || email.isEmpty() || dob.isEmpty() || age.isEmpty() || address.isEmpty() || id.isEmpty()) {
                ...
                try {
                    ...
                    ConnectionClass obj = new ConnectionClass();
                    String q = "UPDATE doctor SET name=?, username=?, password=?, specialization=?, gender=?, phone=?, email=?, dob=?, age=?, address=? WHERE id=?";
